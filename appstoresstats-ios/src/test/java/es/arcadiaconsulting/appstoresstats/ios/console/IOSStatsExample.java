...
public class IOSStatsExample {
	...
	public static void main(String[] args) {
		...
		//get Full app stats
		StatsDataIOS fullStatsdata = (StatsDataIOS) iosQueryHelper.getFullStatsForApp("replaceWithAppleUser", "replaceWithApplePassword", "replaceWithAppSku", "replaceWithVendorID");
		...
		StatsDataIOS datesStatsdata = (StatsDataIOS) iosQueryHelper.getStatsForApp("replaceWithAppleUser", "replaceWithApplePassword", "replaceWithAppSku", datedeployed, datefryday, "replaceWithVendorID");
