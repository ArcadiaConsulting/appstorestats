...
public interface IStoreStats {
	...
	public CommonStatsData getStatsForApp(String user,String password,String appId,Date initDate,Date endDate);
	public List<CommonStatsData> getStatsForAllApps(String user,String password,Date initDate,Date endDate);
	public CommonStatsData getFullStatsForApp(String user,String password,String appId);
