...
public interface DevConsoleAuthenticator {
	...
	// Activity may be needed to start authentication sub activity (password or approval prompt, etc).
        // It needs to override onActivityResult() and retry if RESULT_OK
	SessionCredentials authenticate(boolean invalidate) throws DevConsoleException;
